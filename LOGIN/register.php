...
<head>
  ...
  <h1>Register for Emptylayout.com</h1>
  </head>
  <body>
<form name="frmRegistration" method="post" action="upload.php">
  <table border="0" width="500" align="center" class="demo-table">
   ...
   <tr>
    ...
    <tr>
      <td colspan=2>
      <input type="checkbox" name="terms"> I accept Terms and Conditions <input type="submit" name="register-user" value="Register" class="btnRegister" action="login.php"></td>
    </tr>
  </table>
</form>
